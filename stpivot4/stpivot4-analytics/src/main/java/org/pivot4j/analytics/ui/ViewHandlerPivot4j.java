...
import com.stratebi.stpivot4.analytics.ui.Customizer;

public class ViewHandlerPivot4j implements QueryListener, ModelChangeListener {
	...
	@ManagedProperty(value = "#{customizer}")
...
//			renderer.setEnableSort(isEditable());
		...
		RequestContext.getCurrentInstance().execute(customizer.getLaunch());
